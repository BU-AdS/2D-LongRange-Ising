...
#set xrange       [-20:-20.01]
set yrange       [-50.00:0]
set output 'q=7_m2=5.000e+00_Cm2=2.151973819748_CN=0.06532898.eps'
set terminal postscript color enhanced
#set terminal dumb 120 40

set title "q=7, Levels=8, Vertex-centred, Dirichlet, m^{2} = 5.000e+00" 
...
print 5.000e+00,5.000e+00/(deltaL*(deltaL-1)),exp(NA-NL)
...
set label 2 sprintf("Scaling Factors\n{/Symbol g}_{m^{2}} = %.8f  {/Symbol g}_{N} = %.8f", 2.151973819748, 0.06532898) at -15,(-40) font "courier,14"
